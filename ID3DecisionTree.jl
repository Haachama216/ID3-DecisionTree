mutable struct ID3TreeNode
    attribute::String
    split::Float64
    left::Union{ID3TreeNode, Nothing}
    right::Union{ID3TreeNode, Nothing}
    isLeaf::Bool
    predict::String
end
#default constructor
ID3TreeNode() = ID3TreeNode("",0.0,nothing,nothing,false,"")
